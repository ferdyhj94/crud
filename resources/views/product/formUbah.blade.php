        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ url('ubah-product') }}">
                        {{ csrf_field() }}
                    <input id="id" type="hidden" class="form-control" name="id" value="{{$barang->id}}">
                        ...
                        <div class="form-group{{ $errors->has('jenis_barang') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="jenis_barang" type="text" class="form-control" name="jenis_barang" value="{{$barang->jenis_barang}}" required>
                        ...
                        <div class="form-group{{ $errors->has('harga_beli') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="harga_beli" type="text" class="form-control" name="harga_beli" value="{{ $barang->harga_beli }}" required>
                        ...
                        <div class="form-group{{ $errors->has('harga_jual') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="harga_jual" type="text" class="form-control" name="harga_jual" value="{{ $barang->harga_jual }}" required>
